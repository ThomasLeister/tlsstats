...
/*
 * All the ciphers
 * (for translation in the main software module)
 * Source: http://engineering-you.blogspot.com/2016/05/which-cipher-supports-tls-ssl-client.html
 * Converted using https://regex101.com/
 * 		Regex: 			^.*\[(.*)\]\=(.*)
 * 		Substitution: 	0x$1\:\t\"$2\"\,
 */

// Chiphers maps hex codes of ciphers to their human readable strings."
...
var Alerts map[uint16]string = map[uint16]string{
	0x00: "CLOSE_NOTIFY",
	0x10: "UNEXPECTED_MESSAGE",
	0x14: "BAD_RECORD_MAC",
...
var TLSVersions map[uint16]string = map[uint16]string{
	0x0301: "TLS 1.0",
	0x0302: "TLS 1.1",
	0x0303: "TLS 1.2",
}
